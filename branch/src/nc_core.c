...
#define MAX_CHECKED_TIME_INTERVAL 3000000 /*msec*/
...
core_loop(struct context *ctx)
{
    ...
    if(now - last_checked_time > MAX_CHECKED_TIME_INTERVAL){
        //server_pool_connected_determine(ctx);
        server_pool_active_standby_switch(ctx);
